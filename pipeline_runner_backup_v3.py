    ...
    try:
        ...
        for i, clip in enumerate(clips):
            try:
                ...
                output_clip = os.path.abspath(f"uploads/final_{i}.mp4")
                ...
                if not clip_captions:
                    print("⚠ No captions found, skipping subtitle burn")
                    final_clips.append(input_clip)
                    continue
